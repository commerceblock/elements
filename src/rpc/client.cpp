...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "sendaddtowhitelisttx", 0, "naddresses"},
    { "sendaddmultitowhitelisttx", 1, "basepubkeys"},
    ...
    { "getcontracthash", 0, "blockheight" },
    { "getmappinghash", 0, "blockheight"},
    ...
    { "addmultitowhitelist", 1, "basepubkeys" },
    { "addmultitowhitelist", 2, "nmultisig" },
