 ...
 *  - Direct allocation:
 *    - Size _size: the number of used ocean (between 0 and N)
 *    - T direct[N]: an array of N ocean of type T
 *      (only the first _size are initialized).
 *  - Indirect allocation:
 *    - Size _size: the number of used ocean plus N + 1
 *    - Size capacity: the number of allocated ocean
 *    - T* indirect: a pointer to an array of capacity ocean of type T
 *      (only the first _size are initialized).
 *
