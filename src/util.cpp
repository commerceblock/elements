...
"-anyonecanspendaremine","-fminingrequirespeers","-con_mandatorycoinbase","-recoverwhitelistkeys","-coinbasechange","-signblockscriptchange","-freezelistassetchange","-burnlistassetchange","-whitelistassetchange","-challengeassetchange","-issuanceassetchange","-disabledoutputs"};
bool fDebug = false;
